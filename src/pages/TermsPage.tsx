...
import { Scale, ArrowLeft, Newspaper, Bell } from "lucide-react";
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                <h1 className="text-3xl md:text-4xl font-display font-black text-white uppercase tracking-tighter leading-none">Termos de Uso</h1>
            ...
            <div className="space-y-8 text-slate-400 leading-relaxed font-medium">
              <section className="space-y-4">
                <h2 className="text-xl font-black text-white uppercase tracking-tight flex items-center gap-3">
                  <span className="w-6 h-px bg-primary/50" /> 1. Propriedade Intelectual
                </h2>
                <p>O ecossistema Web Rádio Vitória e todos os seus conteúdos exclusivos são protegidos por leis nacionais e internacionais de propriedade intelectual. O acesso VIP concede o direito de uso pessoal e intransferível.</p>
              </section>

              <section className="space-y-4">
                <h2 className="text-xl font-black text-white uppercase tracking-tight flex items-center gap-3">
                  <span className="w-6 h-px bg-primary/50" /> 2. Responsabilidade do Assinante
                </h2>
                <p>O assinante é responsável pela manutenção do sigilo de suas credenciais de acesso e pelo uso ético das informações e ferramentas disponibilizadas na área de membros.</p>
              </section>

              <section className="space-y-4">
                <h2 className="text-xl font-black text-white uppercase tracking-tight flex items-center gap-3">
                  <span className="w-6 h-px bg-primary/50" /> 3. Política de Assinaturas
                </h2>
                <p>Nossas assinaturas (Mensal, Trimestral e Anual) são renovadas automaticamente, salvo cancelamento prévio pelo usuário através do suporte oficial via WhatsApp ou Telegram.</p>
              </section>
            </div>
          </div>
        </motion.div>
